  ...
  return (
    ...
    <div className="flex min-h-screen">
      ...
      <button
        ...
        className="fixed top-3.5 lg:top-4 right-4 z-50 flex items-center gap-2 px-3 py-1.5 lg:py-2 bg-card border border-border rounded-full text-xs lg:text-sm font-medium hover:bg-accent-light transition-colors shadow-sm"
      >
      ...
      <main
        id="main-content"
        role="main"
        className="w-full lg:ml-64 lg:mr-80 px-6 sm:px-12 lg:px-16 pt-28 lg:pt-16 pb-16 animate-fade-in"
      >
        {/* About */}
        <Section
          id="about"
        ...
        >
          <p className="text-muted text-lg leading-loose text-justify">
            <BoldKeywords text={t.summary} />
          </p>
        </Section>
        ...
        {/* Mobile contact info */}
        <div className="lg:hidden mt-16 p-6 bg-[#1e40af] dark:bg-[#1e3a5f] rounded-2xl">
          <h2 className="text-sm font-semibold uppercase tracking-widest text-white/60 mb-5">
            {locale === "en" ? "Contact" : "Contact"}
          </h2>
          <div className="space-y-3 text-sm">
            <a href="mailto:matei.bargau98@gmail.com" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors">
              <Mail className="w-4 h-4 shrink-0 text-white" aria-hidden="true" />
              matei.bargau98@gmail.com
            </a>
            <a href="tel:+40765262714" className="flex items-center gap-3 text-white/80 hover:text-white transition-colors">
          ...
          <div className="flex gap-4 mt-5 pt-4 border-t border-white/20">
            <a href="https://www.linkedin.com/in/matei-b%C4%83rg%C4%83u/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile" className="text-white/60 hover:text-white transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://github.com/mateibargau" target="_blank" rel="noopener noreferrer" aria-label="GitHub profile" className="text-white/60 hover:text-white transition-colors">
...
function ContactCard({ locale, location }: { locale: string; location: string }) {
  return (
    <div className="hidden lg:block fixed top-16 right-8 z-30 w-64">
